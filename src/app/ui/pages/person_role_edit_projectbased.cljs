(ns app.ui.pages.person-role-edit-projectbased
...
(defnc Renderer [props]
       (let [persons (get-in (use-sub props :persons) [:allPerson])
             ...
             project-name (:project-name route)
             project-id (:project-id route)
             person-name (:person-name route)
             person-id (:person-id route)
             assignment-date (:assignment-date route)
             role-name (:role-name route)
