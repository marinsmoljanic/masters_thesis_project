...
(defclassified HomepageWrapper :div "flex flex-col h-screen w-screen bg-gray-800 md:w-1/2 md:mx-auto shadow")

(defnc HomeRenderer [props]
       ($ HomepageWrapper
          (d/div {:class "flex w-full items-center shadow justify-center py-6 px-2 bg-gray-900 text-gray-700 text-2xl font-thin md:text-gray-800 md:bg-gray-400"}
